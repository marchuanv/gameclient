function DesignerScene(sceneManager, sceneEventManager, sceneObjBuilder, spriteBuilderConfig, imageBuilderConfig, animationBuilderConfig, shapeBuilder, designerSceneConfig, phaserGame, cache, sceneSelector){

	this.phaserGame=phaserGame;

	this.create = function(){
		console.log("BLAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",this.phaserGame);
		var linksAndNodes = this.phaserGame.add.group();
		sceneObjBuilder.getSprites(function(obj, config){
			if (config.name.startsWith("Node")){
				...
				linksAndNodes.add(obj);
				drawLink(config.name, this.phaserGame.input.mousePointer);
			}
