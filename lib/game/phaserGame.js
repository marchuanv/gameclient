        ...
        thisInstance.game =  new thisInstance.Phaser.Game(
            ...
            this.phaserGameConfig.title, {
              preload: function() {
                ...
                thisInstance.add = thisInstance.game.add;
                thisInstance.load = thisInstance.game.load;
                thisInstance.time = thisInstance.game.time;
                thisInstance.state = thisInstance.game.state;
                thisInstance.world = thisInstance.game.world;
                thisInstance.stage = thisInstance.game.stage;
                thisInstance.input = thisInstance.game.input;
                thisInstance.debug = thisInstance.game.debug;
                thisInstance.camera = thisInstance.game.camera;
                thisInstance.physics = thisInstance.game.physics;
                thisInstance.context = thisInstance.game.context;
                thisInstance.math = thisInstance.game.math;
