...
this.initialise = function() {
	...
	phaserGame.input.mouse.mouseDownCallback = function(position) {
		eventHandler.publish(position,null,null, function mouseDown(){ });
	};
	phaserGame.input.mouse.mouseUpCallback = function(position) {
		eventHandler.publish(position,null,null, function mouseUp(){ });
	};
