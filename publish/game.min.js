...
factory(function(factory){
  ...
  factory.register(true, function shapeBuilder(shapeBuilderConfig, phaserGame, eventHandler, cache) {
    ...
    this.createShape = function(sceneConfig, callback) {
      ...
      shape.events.onInputDown.add(function() {
        eventHandler.publish(shape, sceneConfig, state, function shapeDown() {}, this);
      }, this);

      shape.events.onInputUp.add(function() {
        eventHandler.publish(shape, sceneConfig, state, function shapeUp() {}, this);
      }, this);
  ...
  factory.register(true, function sceneObjBuilder(spriteBuilder, animationBuilder, textBuilder, imageBuilder, shapeBuilder, phaserGame, cache) {
  ...
  factory.register(true, function designerScene(sceneManager, sceneObjBuilder, sceneSelector, eventHandler, phaserGame) {
 ...
 }, function error(err){})});factory(function(factory){ factory.register(false, function designerdesignerSceneConfig(){
 return '[{"name":"stateNode1","xPosition":20,"yPosition":20,"xScale":1,"yScale":1,"diameter":100,"type":"shape","enabled":true,"isStatic":false,"shape":"circle","color":"0xFFFFFF"},{"name":"stateNode2","xPosition":120,"yPosition":120,"xScale":1,"yScale":1,"diameter":100,"type":"shape","enabled":true,"isStatic":false,"shape":"circle","color":"0xFFFFFF"}]'; 
